...
class _BaseExperimentConfig:
    ...
    def __init__(self, num_gpus: int = 1):
        ...
        self.data_dir = str(PROJECT_ROOT / "dataset/icons_tensor/")
        self.meta_filepath = str(PROJECT_ROOT / "dataset/icons_meta.csv")
        ...
        self.stats_to_print = {"train": ["lr", "time"]}
