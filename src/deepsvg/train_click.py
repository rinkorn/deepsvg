...
@click.command()
@click.option("--config-module", type=str, required=True)
@click.option("--log-dir", type=str, default="./logs")
@click.option("--debug", action="store_true", default=False)
@click.option("--resume", action="store_true", default=False)
